...
function Events() {
  ...
  <div class="row g-0 h-100">
    <div class="col-md-4">
      <img src="https://indiaeducationdiary.in/wp-content/uploads/2024/11/Pic_2.jpeg" class="img-fluid rounded-start" alt="..."/>
    </div>
  ...
  <div class="row g-0 h-100">
    <div class="col-md-4">
      <img src="https://www.livechennai.com/businesslistings/News_photo/Esports-030425.jpg" class="img-fluid rounded-start" alt="..."/>
    </div>
    <div class="col-md-8 card-background">
      <div class="card-body">
      <div className='d-flex align-items-center mb-4 date'> 
