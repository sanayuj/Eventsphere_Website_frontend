...
function Events() {
  return (
    <div
      className="landingSection3 d-flex flex-column justify-content-center align-items-center"
      id="event"
    >
        ...
        <div>
          <div className="row g-0 h-100">
            <div className="col-md-4">
              <img
                src="https://indiaeducationdiary.in/wp-content/uploads/2024/11/Pic_2.jpeg"
            ...
            <div class="col-md-8 card-background">
              <div class="card-body">
                <div className="d-flex align-items-center mb-4 date">
                  ...
                  <p class="card-text">
                    <small class="">March 15,2024</small>
                  </p>
                </div>
                <h5 class="card-title mb-4 card-head">
                  <Link to={"/Gallery"} style={{ textDecoration: "none", color: "inherit" }}>
                    Tech Innovation Summit 2024
                  </Link>
                </h5>

                <p class="card-text card-content mb-4">
                  Join us for our flagship technology conference featuring
                ...
                <button class="card-text register-Btn">
                  <small class="">
                    Register now <i class="bi bi-arrow-right arrow-custom"></i>
                  </small>
                </button>
              </div>
            </div>
      ...
      <div className="card card-custom">
        ...
        <div>
          <div class="row g-0 h-100">
            <div class="col-md-4">
              <img
                src="https://www.livechennai.com/businesslistings/News_photo/Esports-030425.jpg"
                className="custom-img"
                alt="..."
              />
            </div>
            <div class="col-md-8 card-background">
              <div class="card-body">
                <div className="d-flex align-items-center mb-4 date">
                  <i class="bi bi-calendar4 me-2 "></i>
                  <p class="card-text">
                    <small class="">February 28,2024</small>
                  </p>
                </div>
                <h5 class="card-title mb-4 card-head">
                <Link to={"/Gallery"} style={{ textDecoration: "none", color: "inherit" }}>
                ...
                <p class="card-text card-content mb-4">
                  Our recent esports event brought together top gaming talent
